...
class Screen extends Component {
    ...
    componentDidMount = () => {
        axios
            ...
            .then(response => {
                ...
                this.setState(function () {return {currentRoom: response.data.title, currentDesc: response.data.description, cooldown: response.data.cooldown, coords: response.data.coordinates, exits: response.data.exits,
    ...
    handleFormSubmit = (event) => {
        ...
        if (this.state.input.toLowerCase() === "n" || this.state.input.toLowerCase() === "s" || this.state.input.toLowerCase() === "e" || this.state.input.toLowerCase() === "e") {
            ...
            .then(response => {
                console.log(response.data)
                this.setState({currentRoom: response.data.title, currentDesc: response.data.description, cooldown: response.data.cooldown, coords: response.data.coordinates, exits: response.data.exits,
                movesLog: [...this.state.movesLog, 
                    {title: response.data.title,
                    description: response.data.description,
                    players: response.data.players,
    ...
    startBFT = () => {
        ...
        // if (this.state.traversing) {
            ...
            this.setState(function () {return {prevRoom: this.state.currentRoom}})
